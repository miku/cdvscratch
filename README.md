...
* 516 Bilddatensätze, Hermann Struck
* Zionist
* Grafik, Lithographie
* Portraits, Landschaft, WW1, Krieg, Kolonialisierung

Universität Giessen
-------------------

* GeoBib, frühe Holocaustliteratur
* ZMI, Herder-Institut Marburg
* Metadaten, Autorendaten, Locations aus Büchern

* GeoBib, Hessen
* Georeferenzierte Online-Bibliographie
* 1933-1949
* BMBF, ZMI (Host), Arbeitsstelle Holocaustliteratur
* Projektdaten, Virtueller Atlas der Literatur
* Herkunft: Texte, Archive, GeoDaten und Karten
* frühe Texte zugänglich machen in einem Portal
* bibliographische Daten
* 4100 Personen
* 700 Werke, XML, Orte
* 1700 Orte, CSV Tabelle mit Location, geonames

Mögliche Anwendungen:

* Linked-Open Data
* Erstellung von Visualisierungen basierend auf der Netzwerkstruktur der Daten
* Wo sind diese Werke zu finden (z.B. BSB)

Landesarchiv BaWü
-----------------

* 150 Patente, vergessene Erfindungen
* Brezelmaschine
* Automatisches Spielen mit Tasteninstrumenten

Language Science Press
----------------------

* Sprachwissenschaftliche Bücher
* 10k linguistische Beispiele
* Geoinformation
* CSV, XML, BibTex, RDF, CC-BY

* 6 Bücher, CC-BY
* The Alor-Pantar languages
* Linguistische Beispiele, auf Morphemebene
* WALS, cross-linguistic data project
* 180 Merkmale, 2500 Sprachen
* e.g. SOV, SVO, VSO
* sparse matrix, 13%
* Genealogie
* apics, eWAVE, SAILS, PHOIBLE - andere Projekte
* The intercontinental Dictionary Series
* 1429 Bedeutungen, 288 Sprachen, Wort für Wasser
* Ähnliche sets: Numerals, WOLD
* Glottolog, Subfamilies of languages, mit bibliographischen Referenzen
* Total: 50k linguistische Beispiele, 500k typologische Datenpunkte, 25k Sprachen/Dialekte mit Klassifikation und Literaturangaben
* 250k Literaturangaben
* csv, xml, rdf (nicht ganz granular), bibtex
...
* Portraitindex, 14k Abbildungen, 16./19. Jh.
* TIFF, flickr
* XML
* GND
